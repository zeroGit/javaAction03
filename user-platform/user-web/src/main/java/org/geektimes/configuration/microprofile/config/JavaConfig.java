...
public class JavaConfig implements Config {
    ...
    public JavaConfig() {
        ...
        ServiceLoader<Converter> convertersLoad = ServiceLoader.load(Converter.class, classLoader);
        convertersLoad.forEach(c -> {
            Class c1 = c.getClass().getSuperclass();
            ...
            converters.put(actualTypeArgument, c);
        });
    }
